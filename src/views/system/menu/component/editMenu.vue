      ...
      <el-form :model="state.ruleForm" size="default" label-width="80px">
        <el-row :gutter="35">
          ...
          <template v-if="state.ruleForm.menuType === 'menu'">
            ...
            <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-20">
              <el-form-item label="链接地址">
                <el-input v-model="state.ruleForm.meta.isLink" placeholder="外链/内嵌时链接地址（http:xxx.com）" clearable :disabled="!state.ruleForm.isLink" />
              </el-form-item>
            </el-col>
            <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-20">
          ...
          <template v-if="state.ruleForm.menuType === 'btn'">
            <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-20">
              <el-form-item label="权限标识">
                <el-input v-model="state.ruleForm.btnPower" placeholder="请输入权限标识" clearable />
              </el-form-item>
            </el-col>
          </template>
          <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb-20">
...
const openDialog = (row: any) => {
  ...
  // row.component = `${row.component} `.match(/\'(.+)\'/g)?.join('').replace(/\'/g, '')
  // state.ruleForm = row
